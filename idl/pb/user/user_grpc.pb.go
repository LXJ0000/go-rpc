...
type UserServiceClient interface {
	...
	Logout(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserCommonResponse, error)
}
...
func (c *userServiceClient) Logout(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserCommonResponse, error) {
	out := new(UserCommonResponse)
...
type UserServiceServer interface {
	...
	Logout(context.Context, *UserRequest) (*UserCommonResponse, error)
...
func (UnimplementedUserServiceServer) Logout(context.Context, *UserRequest) (*UserCommonResponse, error) {
